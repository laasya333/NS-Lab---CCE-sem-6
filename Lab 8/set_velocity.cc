...
main (int argc, char *argv[])
{
 ...
 anim.SetConstantPosition(p2pNodes.Get(0),61,63);
 anim.SetConstantPosition(p2pNodes.Get(1),122,63);
 anim.SetConstantPosition(wifiStaNodes.Get(0),59.0,60.0);
 anim.SetConstantPosition(wifiStaNodes.Get(1),20.0,10.0);
 anim.SetConstantPosition(wifiStaNodes.Get(2),40.0,20.0);
 anim.SetConstantPosition(wifiStaNodes.Get(3),60.0,30.0);
